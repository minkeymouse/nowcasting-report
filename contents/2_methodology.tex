...
Forecasting은 과거 데이터를 사용하여 미래 값을 예측하는 기법임. 본 연구에서는 각 모형-대상 조합에 대해 단일 모형을 훈련한 후, 해당 모형을 사용하여 예측 수평선(1개월부터 22개월까지)에 대해 예측을 생성함. 훈련 기간은 1985-2019년이며, 훈련-테스트 분할은 80\%-20\%로 설정됨. 각 수평선에 대한 지표를 계산한 후, 모형-대상 조합별로 1개월부터 22개월까지의 수평선에 대해 평균을 계산하여 최종 성능 지표로 사용함.
