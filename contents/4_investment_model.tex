...
VAR again demonstrates excellent 1-day forecast accuracy (sMSE $\approx 3.7 \times 10^{-9}$, sRMSE $\approx 6.0 \times 10^{-5}$) but completely fails for longer horizons, with errors exploding to impractical magnitudes (sRMSE $> 10^{13}$ for h=7, $> 10^{60}$ for h=28). This numerical instability renders VAR unsuitable for investment forecasting beyond the immediate next period.
