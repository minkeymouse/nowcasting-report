...
표~\ref{tab:forecasting_results}의 결과를 보면, VAR 모형이 KOWRCCNSE 대상 변수에서 최고 성능을 보였으며(sMAE: 0.3161, sMSE: 0.1974), 다른 모형들은 대상 변수에 따라 다양한 성능을 보임. ARIMA는 세 대상 변수 모두에서 안정적인 성능을 보였으며, DFM과 DDFM은 중간 수준의 성능을 보임.
