...
결과를 보면, DDFM 모형이 DFM 모형보다 전반적으로 우수한 성능을 보이며, 특히 KOIPALL.G에서 큰 성능 차이를 보임(DFM-4weeks sMSE: 16155.6 vs DDFM-4weeks sMSE: 81.7). 또한 예상대로 1주 전 예측이 4주 전 예측보다 대부분의 경우 더 정확함(DDFM-1week가 DDFM-4weeks보다 낮은 오차). 다만 KOIPALL.G의 경우 DFM 모형에서 1주 전 예측이 4주 전 예측보다 오히려 높은 오차를 보이는데, 이는 모형의 수렴 문제나 데이터 특성으로 인한 것으로 보임.
