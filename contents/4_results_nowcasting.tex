...
Nowcasting은 공식 통계가 발표되기 전에 현재 시점의 거시경제 변수를 추정하는 기법임. 본 연구에서는 DFM과 DDFM 모형에 대해서만 Nowcasting 백테스트를 수행하여 실제 운영 환경에서의 성능을 평가함. ARIMA와 VAR 모형은 release date 마스킹을 효과적으로 처리하기 어려워 Nowcasting 실험에서 제외되었으며, 이는 단변량/다변량 시계열 모형의 구조적 한계 때문임. 실험 결과, DFM과 DDFM 모형 모두 세 가지 대상 변수에서 성공적인 결과를 얻었음.
