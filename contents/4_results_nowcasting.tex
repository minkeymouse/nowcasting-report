...
Nowcasting은 공식 통계가 발표되기 전에 현재 시점의 거시경제 변수를 추정하는 기법임. 본 연구에서는 모형(ARIMA, VAR, DFM, DDFM)과 대상 변수(3개)에 대해 Nowcasting 백테스트를 수행하여 실제 운영 환경에서의 성능을 평가함. 실험 결과, DFM과 DDFM 모형에 대해서는 모든 대상 변수에서 성공적인 결과를 얻었으며, ARIMA와 VAR 모형에 대해서는 기술적 제한사항으로 인해 결과가 제한적임.
