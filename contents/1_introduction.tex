...
\subsubsection{반면, COVID-19 이후 디지털화의 가속화와 함께 활용 가능한 고빈도 데이터의 양과 다양성은 크게 증가함}
\begin{itemize}
...
\begin{itemize}
    ...
    \item 마스킹된 데이터를 활용한 백테스팅을 통해 DFM과 DDFM의 나우캐스팅 성능을 비교할 수 있도록 설계함. 현재 실험 결과가 확보되지 않아 구체적인 성능 비교는 제한적임
    \item DFM과 DDFM에 대한 Ablation study를 수행하여 각 하이퍼파라미터가 모형 성능에 미치는 영향을 분석할 수 있도록 설계함. 현재 실험 결과가 확보되지 않아 구체적인 분석은 제한적임
\end{itemize}
