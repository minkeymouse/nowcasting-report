...
dfm-python은 고차원 시계열 데이터의 나우캐스팅과 예측을 위한 동적 요인 모형(Dynamic Factor Model, DFM)의 포괄적인 Python 구현체임. 본 연구에서는 dfm-python 패키지를 활용하여 DFM과 DDFM(Deep Dynamic Factor Model) 모형을 사용하도록 설계함.
