...
\textbf{ARIMA:}
\begin{itemize}
    \item 평가 과정에서 기술적 문제로 인해 사용 가능한 결과가 제한적임
    \item 특징: 단순성, 해석 가능성, 안정적 성능 (이론적)
    \item 현재 실험에서는 세 대상 변수 모두에서 결과 생성에 실패함
\end{itemize}
...
\begin{itemize}
    ...
    \item 결과: DFM과 DDFM은 모든 대상 변수에서 성공적으로 결과를 생성했으며, ARIMA와 VAR은 기술적 제한사항으로 인해 결과가 제한적임
\end{itemize}
