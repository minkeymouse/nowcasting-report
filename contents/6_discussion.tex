...
\textbf{ARIMA:}
\begin{itemize}
    \item KOEQUIPTE: 1개월 sMAE = 0.8734, sMSE = 0.7628; 11개월 sMAE = 2.0917, sMSE = 4.3751; 22개월 sMAE = 0.0846, sMSE = 0.0071
    \item 특징: 단순성, 해석 가능성, 안정적 성능
    \item KOIPALL.G, KOWRCCNSE: 결과 미사용 가능
\end{itemize}

\textbf{VAR:}
\begin{itemize}
    \item KOEQUIPTE: 1개월 매우 낮은 오차 (sMAE $<$ 10$^{-4}$, sMSE $<$ 10$^{-8}$), 11개월/22개월 수치적 불안정성
