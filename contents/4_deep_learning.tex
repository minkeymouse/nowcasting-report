...
\paragraph{보편적 근사 정리}
보편적 근사 정리(Universal Approximation Theorem)에 따르면, 충분히 넓은 하나의 은닉층을 가진 신경망은 임의의 연속 함수를 임의의 정확도로 근사할 수 있다. 이는 충분한 데이터와 계산 자원이 주어지면, DDFM이 임의로 복잡한 비선형 관계를 학습할 수 있음을 보장한다.
