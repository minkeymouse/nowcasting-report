...
\begin{itemize}
    \item 모든 목표 변수에서 DDFM이 DFM보다 우수한 성능을 기록함
...
\begin{itemize}
    ...
    \item DDFM이 모든 마스킹 기간에서 DFM보다 우수한 성능을 유지함
...
\begin{itemize}
    \item 요인 개수가 너무 적거나 많을 경우 성능이 저하됨
\end{itemize}
...
\begin{itemize}
    ...
    \item DDFM과 TFT는 상대적으로 안정적인 성능을 유지함
...
\begin{itemize}
    \item DDFM이 모든 목표 변수에서 최우수 성능을 기록함
...
\begin{itemize}
    \item DDFM의 예측값이 실제값에 가장 근접함
    \item 특히 변동성이 큰 시기(예: COVID-19 팬데믹 기간)에서도 안정적인 예측 성능을 유지함
\end{itemize}
