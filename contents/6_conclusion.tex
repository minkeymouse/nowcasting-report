...
\textbf{VAR Limitations:} While VAR produces exceptional 1-day forecasts (sRMSE < 10⁻⁴ for all targets), the model suffers from severe numerical instability for longer horizons. For 7-day and 28-day forecasts, VAR errors explode to impractical magnitudes (sRMSE > 10¹¹), rendering the model unsuitable for multi-step ahead forecasting. This instability is a fundamental limitation of VAR models when forecasting beyond very short horizons, likely due to error accumulation and potential non-stationarity issues.
