...
예측값 vs 실제값 비교 그래프는 부록 B(그림~\ref{fig:appendix_forecast_vs_actual_production}, 그림~\ref{fig:appendix_forecast_vs_actual_investment}, 그림~\ref{fig:appendix_forecast_vs_actual_consumption})를 참조함.
