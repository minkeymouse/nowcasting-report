...
|--------|-------------------|--|-------------------|--|
| | sMSE | sMAE | sMSE | sMAE |
| DFM | 94621.89 | 261.34 | 22904.65 | 123.17 |
| DDFM | 1.92 | 1.14 | 1.62 | 1.00 |
| MAMBA | 1.78 | 1.18 | 1.53 | 0.93 |
...
◦ MAMBA는 투자 지표에서 sMSE 1.53, sMAE 0.93로 우수한 성능을 보였으며, 생산 지표에서도 sMSE 1.78, sMAE 1.18로 DDFM과 유사한 우수한 결과를 보임
◦ 투자 지표와 생산 지표 모두에서의 우수한 성능은 시간 가변 선택적 상태공간 구조가 다양한 변수간 관계를 포착하는 데 효과적이었음을 시사하며, 충분한 훈련 데이터 컨텍스트를 제공할 때 특히 강점을 보임
