...
◦ 생산 지표에서 sMSE 2.07, sMAE 1.28로 이전 결과(2.10, 1.29) 대비 소폭 개선됨
◦ 투자 지표에서는 sMSE 1.51, sMAE 0.93으로 상대적으로 양호한 성능을 보여 혼합 주기 구조가 투자 데이터에 더 잘 맞는 양상을 보임
