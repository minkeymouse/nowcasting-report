...
\begin{center}
\Large\textbf{대한민국 거시경제 Nowcasting: 데이터 기반 조기경보지수 구축}
\end{center}
\vspace{1cm}
...
\input{contents/2_experiment_setup}

\input{contents/3_experiment_result}

\input{contents/4_early_warning}

\input{contents/5_conclusion}

\section*{Appendix}

\input{appendix/A_additional_sources}

\input{appendix/B_forecasting_experiment_details}

\input{appendix/C_nowcasting_experiment_details}

\input{appendix/D_mixedfreq_experiment_details}
